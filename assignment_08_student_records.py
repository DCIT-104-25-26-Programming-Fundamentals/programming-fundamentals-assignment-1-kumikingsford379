...
def add_student(students):
    """Prompts for student details and adds a record dictionary to the list."""
    ...
    try:
        ...
        print("Error: Invalid input. Please enter valid numbers for scores.")
...
def display_all_students(students):
    """Prints all student records in a neatly aligned table."""
    if not students:
    ...
    for s in students:
        ...
        print(f"{s['name']:<15} {s['id']:<11} {scores_str:<14} {avg:<8.2f}")
